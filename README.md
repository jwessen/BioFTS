...
$$
Q = \frac{1}{V} \left( \frac{3}{2 \pi b^2} \right)^{\frac{3(N-1)}{2}} \left( \prod_{\alpha=1}^N \int \mathrm{d} \vec{R}_\alpha \right) \exp \left[ - \frac{3}{2 b^2} \sum ( \vec{R}_{\alpha+1} - \vec{R}_{\alpha} )^2 \right]
$$
